...
const CardProfile = ( {id, srcImg, name, no, footer, redirectLabel, onClick = () => {}}: Props ) => {
   return (
      <div className="w-[250px] aspect-4/6 overflow-hidden rounded-2xl relative shrink-0 flex flex-col items-center p-5 border border-white group cursor-pointer shadow-md" onClick={() => onClick(id)}>
         ...
         <div className="w-[50%] aspect-square overflow-hidden rounded-full relative z-1 group-hover:-translate-y-50 ease-in-out duration-500">
            <img src={srcImg} alt="vet profile picture" loading="lazy" />
         </div>
