         ...
         <div className="w-full max-w-[1536px] h-20 flex justify-between items-center px-5 py-3 ">
            <div className="h-12 flex items-center gap-2 relative">
               ...
               <h1 className={`
                  ...
                  font-inter font-bold tracking-tighter absolute top-1/2 -translate-y-1/2 left-15
                  ${isLeaveHero && isHome ? "" : "top-40 left-5 sm:left-8 scale-200 sm:scale-300 lg:scale-500 origin-left"}
                  ...
                  {NavbarLink.map((link, index) => (
                     <NavLink 
                        ...
                        className="group relative flex items-center text-sm font-inter px-10">
                           ...
                           <hr className="absolute right-0 bottom-0 w-0.5 h-6 bg-[var(--tertiary-color)] group-hover:w-full group-hover:h-0.5 ease-in-out duration-300"/>
                     </NavLink>
                  ))}
               </ul>
