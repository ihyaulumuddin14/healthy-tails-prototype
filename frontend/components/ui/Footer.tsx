...
export default function Footer ({ sectionIDs }: FooterProps) {

   return (
      <section className='w-full h-fit flex justify-center items-center bg-[var(--color-accent)] relative z-1 overflow-hidden pt-20 rounded-t-4xl'>
         <div className='content-wrapper items-center p-[min(7vw,100px)] grid lg:grid-cols-2 grid-cols-1 gap-10'>
            ...
            <div className='w-full h-fit flex flex-col gap-5'>
               ...
               <div className='flex justify-start items-center w-full max-w-[300px] h-fit gap-5'>
                  <ContrastButton model='fill' >Book a Visit</ContrastButton>
