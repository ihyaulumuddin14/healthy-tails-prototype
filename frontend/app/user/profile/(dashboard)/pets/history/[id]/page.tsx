...
import { getHistoryOfPet } from '@/api/pet.actions';
...
export default function HistoryPage({
   ...
   useEffect(() => {
      const fetchHistory = async () => {
         ...
         const data = await getHistoryOfPet({ id });
   ...
   return (
      <DashboardContent title='Visit History' subtitle='Here you can view a complete record of your pet’s veterinary visits, including diagnoses, treatments, and follow-up care.'>
         ...
         {sortedHistories.length > 0 ? (
            ...
            <div className="text-center text-2xl font-bold text-gray-600">No History Found</div>
         )}
      </DashboardContent>
   )
}
