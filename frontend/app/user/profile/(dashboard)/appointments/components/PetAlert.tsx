                        ...
                        <div className="w-full h-full flex flex-col-reverse sm:flex-col justify-between gap-5 py-4 min-w-[210px]">
                           ...
                           <div className="w-full flex flex-col">
                              ...
                              <p className="text-xs flex gap-2 items-center">
                                 ...
                                 {booking.bookingDate.toLocaleDateString('id', { weekday: 'long', day: 'numeric', month: 'short', year: 'numeric' })}, {booking.bookingDate.toLocaleTimeString('id', { hour: 'numeric', minute: 'numeric' })}
                              </p>
                           </div>
                        </div>
                     </div>
