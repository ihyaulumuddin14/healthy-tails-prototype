...
export default function AuthLayout({ children, title, subtitle, type = '' }: AuthLayoutProps) {
   return (
      <section className='w-full min-h-screen h-fit pt-10 flex flex-col items-center bg-[var(--primary-color)] text-[var(--color-foreground)]'>
         <span className="fixed z-1 top-5 right-5">
            <ThemeToggle />
         </span>
         ...
         <div className='wrapper w-full max-w-xl h-fit flex flex-col justify-center items-center gap-5 p-[min(7vw,50px)] relative'>
            ...
            <main className="w-full">
               ...
               {(type === 'login' || type === 'register') && (
                  <>
                     <Divider>or</Divider>
                     <AnimateFillButton type="button" model="outline" width="full">
