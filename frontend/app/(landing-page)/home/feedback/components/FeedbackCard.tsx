...
export default function CardReview ({ imgSrc, name, reviewText, rating }: Props) {
   ...
   return (
      <div className='feedback-card w-full max-w-[1000px] h-fit grid lg:grid-cols-[1fr_3fr] grid-cols-1 sm:grid-rows-1 relative mb-20 cursor-grab active:cursor-grabbing'>
         <div className='w-full h-full flex flex-col items-center justify-start text-[var(--color-foreground)] p-5 gap-5'>
            <Image
               width={100}
               height={100}
               src={imgSrc}
         ...
         <div className='w-full max-w-full h-full lg:pt-12 p-0 flex flex-col justify-between items-center gap-5'>
            <q className='review-text text-[var(--color-foreground)] w-full break-words text-[clamp(1rem,1.5vw,1.5rem)] font-inter'>
               {reviewText}
            </q>
            
            <div className='flex items-center gap-1 self-end'>
               <p className='text-[clamp(1rem,1.5vw,1.2rem)] font-inter text-[var(--color-foreground)] mr-3'>{rating} |</p>
