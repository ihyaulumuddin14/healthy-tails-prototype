...
export default function ThemeToggle() {
   ...
   return (
      <div onClick={() => setTheme(theme === "dark" ? "light" : "dark")} className="cursor-pointer p-1 rounded-full bg-transparent hover:bg-[var(--color-foreground)]/20 ease-in-out duration-100">
         {theme === "dark" ? (
            <svg className="w-6 h-6 text-[var(--foreground)]" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="none" viewBox="0 0 24 24">
